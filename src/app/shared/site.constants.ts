export const SITE = {
  brandName: 'Daaet Tour And Travel',
...
export const WHY_US = [
  ...
  { title: 'Clear Pricing', desc: 'Upfront estimates with customizable hotel and transport tiers.' },
  { title: 'Verified Network', desc: 'Trusted partners for stays, cabs, and on-ground activities.' },
...
export const PACKAGE_CATEGORIES = ['All', 'Family', 'Couple', 'Adventure', 'Premium'];
...
export const CONTACT_PROCESS = [
  { step: '01', title: 'Share Your Plan', desc: 'Tell us dates, budget, and travel preferences.' },
  { step: '02', title: 'Get Custom Quote', desc: 'Receive itinerary, stays, and transparent pricing.' },
  { step: '03', title: 'Confirm & Travel', desc: 'We coordinate everything with on-trip support.' },
];
